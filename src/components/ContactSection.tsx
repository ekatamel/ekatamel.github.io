        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-in-left">
            ...
            <p className="text-gray-600 mb-8">
              I'm currently looking for new frontend/full-stack opportunities. Whether you have a question or just want to say hello, I'll get back to you as soon as possible!
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="mailto:eka.melnichuk@gmail.com" className="text-lg hover:text-spring-mint transition-colors">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="tel:+420775992148" className="text-lg hover:text-spring-mint transition-colors">
                    +420 775 992 148
                  </a>
                </div>
              </div>
