        ...
        <div className="lg:w-3/4 animate-fade-in">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl">
              IT Professional with 6 years experience creating responsive,
              user-friendly, and high-performance web applications in React.
              Expertise in building scalable platforms, optimizing web
              performance, and automating workflows to enhance user experience.
            </p>
